export const COLORS = {
  ...
  DARKRED: "#6C1400",
  LIGHTYELLOW: "#FFFCD6",
  backgroundColor: "#F9F7EA",
  ACCORDIONHEADERCOLOR: "#881A00",
  YELLOBACKGROUND: "#FFF600",
  PURPLEBACKGROUND: "#40009A",
  PENDING: "#FFF9C4",
  DONE: "#C8E6C9",
  SIGNED_UP: "#BBDEFB",
  PENDING_TEXT: "#EF6C00",
  DONE_TEXT: "#388E3C",
  SIGNED_UP_TEXT: "#0D47A1",
  PURPLE: "#F3E5F5",
  PURPLE_TEXT: "#8E24AA",
  LIGHTGREY: "#EEEFF3",
  PROGRESS25: "#FFCDD2",
...
export const ONBOARDING_JOURNEY_TYPE = {
  ASSESSMENT: "ASSESSMENT",
  SOFT_SKILL: "SOFT_SKILL_ASSESSMENT",
